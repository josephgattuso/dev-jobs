  ...
  return (
    <>
      <div className='relative p-8 pt-0 mx-auto bg-white rounded-md shadow dark:bg-very-dark-blue w-76 md:w-full min-h-card'>
        ...
        <div className='flex items-center pt-12 text-base font-normal leading-5 text-dark-gray font-brand'>
          <p>{formatDate(new Date(job.created_at))} ago</p>
          <p className='ml-3 text-4xl'>&middot;</p>
        ...
        <div>
          <p className='mt-3 text-base font-normal leading-5 font-brand text-dark-gray'>
            {job.company}
          </p>
        </div>
        <div>
        ...
        <Link href={`/jobs/${job.id}`}>
          <div
            title='View Details'
            className='flex py-3 space-x-2 text-center cursor-pointer md:py-4 hover:bg-gray-100'
          >
            <svg
