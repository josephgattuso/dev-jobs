      ...
      >
        ...
        <input
          ...
          className={classNames(
            ...
            isCheckbox
              ? 'cusor-pointer border-0 form-checkbox bg-very-dark-blue bg-opacity-10 dark:bg-white dark:bg-opacity-10 text-violet dark:text-violet ml-5 h-6 w-6 transition duration-150 ease-in-out'
