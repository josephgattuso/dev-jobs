    ...
    <>
      <div className={classNames(darkMode && 'dark')}>
        <div className={'bg-normal-grey dark:bg-midnight'}>
          <div className='flex items-baseline px-6 pt-8 h-34 bg-violet dark:bg-black'>
            <Link href='/'>
              <svg
            ...
            <div className='flex items-center ml-auto space-x-4'>
              ...
              <span
                ...
                className={classNames(
                  'p-1 items-center relative bg-white dark:bg-very-dark-blue inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer w-12 focus:outline-none focus:shadow-outline'
                )}
              >
                <span
                  aria-hidden='true'
                  className={classNames(
                    'inline-block w-3.5 h-3.5 transition duration-200 ease-in-out transform bg-violet dark:bg-white rounded-full shadow',
      ...
      <footer className='fixed bottom-0 z-10 w-screen bg-white border-t border-normal-grey dark:border-very-dark-blue dark:bg-very-dark-blue'>
        <div className='max-w-screen-xl px-4 py-4 mx-auto sm:px-6 md:flex md:items-center md:justify-between lg:px-8'>
          <div className='flex justify-center space-x-6 md:order-2'>
            <a
              ...
              target='_blank'
            >
              <span className='sr-only'>Joseph Gattuso's Personal Website</span>
              <svg
                className='w-6 h-6'
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
